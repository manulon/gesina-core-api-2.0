INSERT INTO gesina."user" (id, first_name, last_name, email, "password") VALUES
	 (1, 'Admin', 'Ina', 'admin@ina.com.ar', 'pbkdf2:sha256:260000$ejlxRPQiZOMWt2o2$f856120dd2d2170c070b1648524000f6803ef28eb2ad9af96523ad900e454743');

INSERT INTO gesina.geometry (id, "name", description, created_at, user_id) VALUES
	 (1, 'Modelo1-Atucha.g01', 'Ejemplo dado por el INA','2021-12-21 20:08:36.377642', 1);

INSERT INTO gesina.geometry (id, "name", description, created_at, user_id) VALUES
	 (2, 'DeltaParana_2017.g23', 'Geometría Paraná','NOW()', 1);
...
INSERT INTO gesina.scheduled_task (id, name, description, frequency, geometry_id, user_id, start_datetime, metadata,
